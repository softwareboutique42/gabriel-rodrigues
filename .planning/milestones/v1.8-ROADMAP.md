...
- [x] 34-01-PLAN.md — Step causality explanations, recap/replay prompts, and bounded card progression visibility
...
- [x] 35-01-PLAN.md — EN/PT dataset/copy parity and host-mode matrix compatibility assertions
...
- [x] 36-01-PLAN.md — Final confidence lock, anti-monetization guardrails, and release verification chain
