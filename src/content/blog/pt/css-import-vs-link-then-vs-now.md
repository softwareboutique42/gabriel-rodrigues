...
Em 2015, fiz uma pergunta no Stack Overflow em Português sobre a diferença entre `@import` e `<link>` para incluir arquivos CSS. Recebeu 12 votos. A resposta era unânime: não use `@import`.
