...
- Usage: Reference from command with `@/home/gabriel/Documents/gabriel-rodrigues/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to /home/gabriel/Documents/gabriel-rodrigues/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to /home/gabriel/Documents/gabriel-rodrigues/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
